...
public class AdEnergyView extends ImageView {
    ...
    public AdEnergyView(Context context) {
        super(context);
        init();
    }

    public AdEnergyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AdEnergyView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(){
        ...
        paintLayer.setColor(Color.YELLOW);
